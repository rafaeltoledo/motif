...
class CodeGenerator(
    ...
    companion object {
        ...
        fun generate(env: ProcessingEnvironment, graph: ResolvedGraph, noDagger: Boolean): List<GeneratedClass> {
            return CodeGenerator(env, graph, noDagger).getScopeImpls()
        }
    }
}